...
var Validation = /** @class */ (function () {
    ...
    Validation.prototype.validationAuth = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var stateValid, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.schemaAuth.validate({
    ...
    Validation.prototype.validationProd = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var body, stateValid, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
exports.valid = new Validation(yup);
