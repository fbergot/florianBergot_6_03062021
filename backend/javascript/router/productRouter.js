...
router.post("/", function (req, res, next) { return (0, sanitize_1.sanitizeDataSauce)(req, res, next, validator_1["default"]); }, function (req, res, next) { return auth.verifAuth(req, res, next); }, multer_config_1["default"], function (req, res, next) { return basicController.save(req, res, next); });
router.post("/:id/like", function (req, res, next) { return (0, sanitize_1.sanitizeDataSauce)(req, res, next, validator_1["default"]); }, function (req, res, next) { return auth.verifAuth(req, res, next); }, function (req, res, next) { return likeController.likeOrDislike(req, res, next); });
router.put("/:id", function (req, res, next) { return (0, sanitize_1.sanitizeDataSauce)(req, res, next, validator_1["default"]); }, function (req, res, next) { return auth.verifAuth(req, res, next); }, multer_config_1["default"], function (req, res, next) { return basicController.update(req, res, next); });
